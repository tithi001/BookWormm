...
<br><br><br>
     <div  class="row" style="width: auto ">
        ...
        <div class="column" style="width: 50%; height:auto; border: thin solid #ccc ">
            <h3 align="center">Update Book Information</h3><hr><br>
       <form action="UpdateBooksInfo" method="post">
            <% while (rs.next()){%>
          
           <input type="hidden" name="book_id"  value="<%=rs.getInt("book_id")%>" >
           &nbsp;   &nbsp;   &nbsp;   &nbsp;
    Book Name:<input type="text" name="book_name" style="width:200px; height:35px;" value="<%=rs.getString("book_name")%> " required><br><br><br><br>
    &nbsp;   &nbsp;   &nbsp;   &nbsp;
    Release Date:<input type="Date" name="release_date"style="width:200px; height:35px;" value="<%=rs.getDate("RELEASE_DATE")%>" required><br><br><br><br>
   &nbsp;   &nbsp;   &nbsp;   &nbsp;
    Author Name: <input type="text" name="author_name" style="width:200px; height:35px;"  value="<%=rs.getString("author_name")%>" required><br><br><br><br>
     &nbsp;   &nbsp;   &nbsp;   &nbsp;
    Description:<input type="text" name="description" style="width:200px; height:150px;"  value="<%=rs.getString("description")%>" required><br><br><br>
     ...
     &nbsp;   &nbsp;   &nbsp;   &nbsp;
       ...
       &nbsp; &nbsp; &nbsp; &nbsp 
           ...
           <input type="checkbox" name="genre" value="<%=gname.get(i)%>" <% if (g_name.contains(g))out.print("checked"); %>  /><%=gname.get(i) %>
           <br>
          <% }%>
