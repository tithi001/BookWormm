...
<!--    navigation bar ends   -->
   ...
   <!-- <div class="row" style="width: auto">
    ...
    <div class="row" style="width: auto">
        ...
        <div class="column" style="width: 1%; background-color: #F6F4EE"></div>
        <div class="column" style="width: 59%; min-height: 200px; border: thin solid #ccc; padding-top: 60px; padding-bottom: 60px; padding-left: 30px; padding-right: 30px">
...
<table cellspacing="30" style="padding-left: 150px">
    ...
    <tr>
            <td><a href="bookPage_1?bId=<%=rs1.getInt("book_id")%>"><img class="sideByside" src="<%=rs1.getString("book_id")%>.jpg" height="150" width="110"></a>
