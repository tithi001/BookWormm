 ...
 <%}%>
    ...
    <hr color="#DEDEDE" width="4"><br><br><br><br><br><br><br><br>
        ...
        <div class="row" style="width: auto">
            ...
            <div class="column" style="width: 1%; background-color: #F6F4EE"></div>
            <div class="column" style="width: 65%;  border: thin solid #ccc; padding-left: 30px ; padding-right: 30px; padding-bottom: 80px; padding-top: 30px">
                <!--    this is middle column   -->
                <!--    erase "height:100px" to set the height according to its elements   -->
                <br>    <br>&nbsp;&nbsp;&emsp;&emsp;
                <b><font size="4" color="#564A3D">  My Books</font></b><hr>
                <br><br><br><br>
                <form action="bookShelf" method="get" style="padding-left: 55px; padding-right: 55px">
                  ...
                  String shelf = rs2.getString("status");%>
                    ...
                    <tr>
                        ...
                        <td></td>
                        <td></td>
                        <td><input type="submit" class="button1" value="Update" style="border: thin solid #ccc; color: #3E1B0F; font-size: 14px"></td></tr>
                    <%}%>
                </table></form>
            </div>
