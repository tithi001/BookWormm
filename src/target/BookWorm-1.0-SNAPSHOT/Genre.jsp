...
<div class="row" style="width: auto">
        ...
        <div class="column" style="width: 50%; min-height: 400px; border: thin solid #ccc; padding-bottom: 80px; padding-top: 50px; padding-left: 30px; padding-right: 30px">
            ...
            <div class="row" style="width: auto"><font style="font-size: 18px">All Books by </font><hr></div>
          ...
          ArrayList <String> gname=(ArrayList<String>)session.getAttribute("gname");
           for (int i = 0; i <gname.size(); i++) {
            ...
            if(rs.next()){ %>
                             ...
                             <h2 align="center "> <%= gname.get(i) %>        </h2>
<table cellspacing="70" >
   <tr>  <td>   <a href="bookPage_1?bId=<%=rs.getInt("book_id") %>"><img class="sideByside" src="image/<%=rs.getString("book_id")%>.jpg"></a></td>
