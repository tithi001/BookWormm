...
<!--    navigation bar ends   -->
    ...
    <div class="row" style="width: auto">
        ...
        <div class="column" style="width: 50%; min-height: 400px; border: thin solid #ccc; padding-bottom: 80px; padding-top: 50px; padding-left: 30px; padding-right: 30px">
                  <%  String msg=" updated...";
    String newBook= (String)session.getAttribute("oldBook");
    if(newBook!=null && newBook.equals("updated")){%><h2 align="center"><%=msg
    %></h2>
        <%
 ...
 <%  msg=" deleted successfully...";
    ...
    if(newBook!=null && newBook.equals("deleted")){%><h2 align="center"><%=msg
    %></h2>
        <%
            session.removeAttribute("deleteBook");
}%>
 
            <div class="row" style="width: auto"><font style="font-size: 18px">All Books</font><hr></div>
            ...
            Released on <%=rs.getDate("release_date") %></td>
             <td><%if(admin){%>
                <a href="deleteBook?bId=<%=rs.getInt("book_id") %>">
                        <input type="button" value="delete" onclick="return confirm ('Are you sure want to delete?');" style="border: thin solid #ccc; color: #3E1B0F; font-size: 14px"></a><br>
                       <%}%> 
            
        <br><br> <a href="updateBookInfo.jsp?upId=<%=rs.getInt("book_id") %>">
            <%if(admin){%>
            <input type="button" value="update" style="border: thin solid #ccc; color: #3E1B0F; font-size: 14px"></a>
            <%}%> 
            <br>
