...
<!--    navigation bar ends   -->
    ...
    <div class="row" style="width: auto">
        <div class="column" style="width: 25.5%; background-color: #F6F4EE"></div>
      
        <div class="column" style="width: 1%; background-color: #F6F4EE"></div>
        <div class="column" style="width: 49%; min-height: 100px; border: thin solid #ccc; padding-bottom: 60px">
            <!--    this is middle column   -->
            <!--    erase "height:100px" to set the height according to its elements   -->
            
        <br><br><br><br>
        &nbsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&nbsp;
        <font size="4" color="#564A3D"><b>Edit Profile</b></font>&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;
        ...
        <form name="myform" action="EditProfile" method="POST" onsubmit="return validate_form();">
           ...
           <input type="submit" class="button1" value="Save Profile Settings" name="submit" style="border: thin solid #ccc; color: #3E1B0F; font-size: 14px"/>
            &emsp;&emsp;&emsp;&emsp; &emsp;&nbsp;&emsp;&nbsp;&emsp;&nbsp;
            <input type="reset" class="button1" value="Clear" name="clear" style="border: thin solid #ccc; color: #3E1B0F; font-size: 14px" />
        </form>
