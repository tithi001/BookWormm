...
<!--    navigation bar ends   -->
    ...
    if(oldPassword!=null && oldPassword.equals("deleted")){%><h2 align="center"><%=msg
    %></h2>
        <%
    ...
    %>  
        ...
        <tr>
          ...
          <td>  Username:<%=rs.getString("USERNAME") %><br>
          ...
          Email: <%=email %><br><br>
           Age: <%=rs.getInt("AGE") %><br><br>
            ...
            <td>
                <a href="deleteUser?email=<%=email%>"><b><input type="button" value="delete" 
                                                                              onclick="return confirm ('Are you sure want to delete?');"> </b></a><br>
